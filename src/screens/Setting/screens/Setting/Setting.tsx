...
import { AGREEMENT_MAIN_URL, CS_CENTTER_URL, EVENT_NOTICE_URL } from '@commons/contents/agreement/agreementUrls';
    ...
    <>
      <S.Wrapper>
        ...
        <S.MenuWrapper>
          ...
          <S.MenuButton onPress={handleLinkPress(CS_CENTTER_URL)}>
        ...
        <S.BottomWrapper>
          ...
          <CustomText margin="16px 0" onPress={() => hanldeOuterLinkModal(EVENT_NOTICE_URL)}>
            이벤트 및 공지사항
          </CustomText>
          <S.BetweenWrapper>
            <S.RowWrapper>
